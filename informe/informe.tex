...
Todas las pruebas se realizaron utilizando los archivos propuestos por la cátedra sobre el emulador GXemul (tanto para la version MIPS como para la version C).

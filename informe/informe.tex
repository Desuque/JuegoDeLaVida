...
\author{	José Ignacio Sbruzzi, \textit{Padrón Nro. 97.452}                     \\
            ...
            Leandro Huemul Desuque, \textit{Padrón Nro. 95836}                     \\
...
OJO CON QUE LOS PARAMETROS NO SE ALMACENAN, TERMINAR Y REVISAR
Los parámetros no se almacenan ya que no fue necesario, al ser una matriz cuadrada (MxM), el cálculo de la posición relativa se hizo utilizando solo el ancho. Se pasó el alto para cumplir con la firma pedida por el trabajo práctico y para contemplar posibles mejoras u optimizaciones a futuro (por ejemplo, que se permitan matrices de MxN).

LEANDRO acordate del coso del stack, revoleame un png y yo lo enchufo bien acá
...
HACERRR
acá tenes que anteponer time a la corrida de conway y linux te toma cuánto tardan las cosas, fijate cuánto cambia con el .S y sin el .S y listo, 3 líneas
